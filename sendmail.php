...
if (isset($_POST['email'])) {
    ...
    $email_to = "dangpark17@gmail.com";

    $email_subject = "Contacto Legorreta";
...
//Se crean los encabezados del correo
    ...
    if ($send) {
        ...
        echo '<script language="JavaScript"> window.location.href ="http://legorreta-kleinundgross.000webhostapp.com/contacto.html" </script>'; //Redirección a la pagina que gusten
    }
